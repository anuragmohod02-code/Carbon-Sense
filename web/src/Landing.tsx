  ...
  return (
    <div className="min-h-screen">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-[#0a0a0f]/80 border-b border-zinc-800/50">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-semibold tracking-tight">Carbon Sense</span>
          </div>
          <Link
            to="/dashboard"
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 px-6">
        ...
        <div className="relative z-10 max-w-[800px] text-center space-y-8 animate-in">
          ...
          <p className="text-lg md:text-xl text-zinc-400 max-w-[600px] mx-auto leading-relaxed">
            Carbon Sense intercepts your LLM calls, compresses prompts, routes to efficient models,
            ...
            <div ref={howStep1.ref} className={howStep1.className + " flex flex-col md:flex-row items-center gap-10 md:gap-16"}>
              <div className="flex-1 order-2 md:order-1">
                ...
                <p className="text-zinc-400 leading-relaxed">
                  Carbon Sense sits transparently between your code and the LLM API. Every prompt
        ...
        <div ref={impact.ref} className={`max-w-[900px] mx-auto ${impact.className}`}>
          ...
          <div className="card p-8 md:p-12 text-center">
            ...
            <p className="text-zinc-500 text-sm mt-3 max-w-[400px] mx-auto">
              ...
              With a team of 10 developers, Carbon Sense can offset
      ...
      <footer className="border-t border-zinc-800/50 py-8 px-6 text-center text-[12px] text-zinc-600">
        Carbon Sense — Making AI sustainable, one prompt at a time.
      </footer>
    </div>
  );
}
